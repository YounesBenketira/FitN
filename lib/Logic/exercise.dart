  ...
  Exercise({this.id, this.workout, this.theme}) {
    switch (this.workout) {
      case Workout.ArnoldDumbbellPress:
        ...
        this.icon = Image.asset('images/shoulders.png');
        break;
      ...
      case Workout.TricepsExtension:
        ...
        this.icon = Image.asset('images/arms.png');
        break;
      ...
      case Workout.CableCrossover:
        ...
        this.icon = Image.asset('images/chest.png');
        break;
      ...
      case Workout.BarbellRow:
        ...
        this.icon = Image.asset('images/back.png');
        break;
      ...
      case Workout.BarbellFrontSquat:
        ...
        this.icon = Image.asset('images/legs.png');
        break;
      ...
      case Workout.AbWheelRollout:
        ...
        this.icon = Image.asset('images/abs.png');
        break;
      ...
      case Workout.Cycling:
        this.title = 'Cycling';
        this.icon = Image.asset('images/cardio.png');
        break;
